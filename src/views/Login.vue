            ...
            this.axios.post(url, this.user)
                .then(res => {
                    ...
                    if (res.data.success == true) {
                        ...
                        this.$emitter.emit('pushToastMessage',{style:'success',title:'Login Success',content:'登入成功'});
                    }
                    else {
                        alert(res.data.message);
                        this.$emitter.emit('pushToastMessage',{style:'fail',title:'Login Failed',content:'登入失敗'});
                    }
                })
                .catch(err => {
                    console.log(err);
